...
(
    ...
    `name`                 VARCHAR(100) CHARSET utf8_mb4 COLLATE utf8_bin NOT NULL COMMENT 'Name of the discipline.',
    `description`          VARCHAR(500) CHARSET utf8_mb4 COLLATE utf8_bin NOT NULL COMMENT 'Description of the discipline.',
