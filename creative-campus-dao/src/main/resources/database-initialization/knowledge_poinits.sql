...
(
    ...
    `name`               VARCHAR(200) CHARSET utf8_mb4 COLLATE utf8_bin NOT NULL COMMENT 'Name of the knowledge point.',
    `description_url`    VARCHAR(200) CHARSET utf8_mb4 COLLATE utf8_bin NOT NULL COMMENT 'URL of the description of the knowledge point.',
