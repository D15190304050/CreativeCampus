...
(
    ...
    `question_body_url` VARCHAR(200) CHARSET utf8_mb4 COLLATE utf8_bin NOT NULL COMMENT 'URL of the question body.',
    `discipline_id` BIGINT NOT NULL COMMENT 'ID of the discipline that the question belongs to.',
    `answer_body_url` VARCHAR(200) CHARSET utf8_mb4 COLLATE utf8_bin NOT NULL COMMENT 'URL of the answer body of the question.',
    `estimated_time_to_finish` INT NOT NULL COMMENT 'Estimated time to finish the question, unit: seconds.',
    `tag` VARCHAR(500) CHARSET utf8_mb4 COLLATE utf8_bin DEFAULT NULL COMMENT 'Other information of this question.',
